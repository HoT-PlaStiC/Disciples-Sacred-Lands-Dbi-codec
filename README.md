...
Please note, that not all files are extendable (yet) so for safe work i suggest to use replace instead of new item, you can extend unit.dbi safely, but for other files i suggest to make backups before testing. Every feedback are welcome!
