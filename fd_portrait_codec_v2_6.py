...
Használat:
  ...
  # Saját kép beillesztése UNIT.DBI-ba:
  python fd_portrait_codec_standalone.py encode sajat.png UNIT.DBI FD026S00 IMGGRAB.BIN
...
def main():
    ...
    elif cmd=='encode' and len(sys.argv)>=6:
